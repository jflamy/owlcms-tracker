...
<div class="running-elements-container">
  ...
  {#if headerLeftUrl && showHeaderLeft}
    <div class="header-left-logo"><img src="{headerLeftUrl}" alt="Left logo" on:error={hideHeaderLeftLogo} /></div>
  {:else}
    <div class="header-left-logo"></div>
  {/if}
  {#if headerRightUrl && showHeaderRight}
    <div class="header-right-logo"><img src="{headerRightUrl}" alt="Right logo" on:error={hideHeaderRightLogo} /></div>
  {:else}
