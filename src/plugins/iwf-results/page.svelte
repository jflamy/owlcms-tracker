    ...
    {#each sessions as session}
      <div class="session-page">
        <div class="session-title">
          <p><strong>{data.competition.name}</strong></p>
          <p>{data.competition.city}   {data.competition.dateRange}</p>
            ...
            {#each session.athletes as category}
              ...
              {#each category.items as athlete}
                <tr>
                  ...
                  <td class="col-rank">{athlete.snatchRank || '-'}</td>
                  ...
                  <td class="col-rank">{athlete.cleanJerkRank || '-'}</td>
                  <td class="col-total">{athlete.total || '-'}</td>
                  <td class="col-rank">{athlete.totalRank || '-'}</td>
                </tr>
              {/each}
            {/each}
          </tbody>
        ...
        <div class="page-footer">
          <span class="production-time">Generated: {data.productionTime}</span>
...
<style>
  ...
  @media print {
    ...
    .records-section, .officials-section {
      page-break-inside: avoid;
      break-inside: avoid;
    }
    ...
    .protocol-table, .records-table, .officials-grid {
      page-break-inside: avoid;
      break-inside: avoid;
    }

    /* Hide any UI elements if they existed */
    .no-print {
      display: none;
    }
  }
