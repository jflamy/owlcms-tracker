# Ohio WSO Lower Third - Minimal Status Overlay
...
### Basic URL
```
http://localhost:8096/ohio-wso-lower-third?fop=Platform_A
```
...
**Bottom left corner:**
```
http://localhost:8096/ohio-wso-lower-third?fop=Platform_A&position=bottom-left
```

**Large text for 4K displays:**
```
http://localhost:8096/ohio-wso-lower-third?fop=Platform_A&fontSize=large
```

**Top right corner with small text:**
```
http://localhost:8096/ohio-wso-lower-third?fop=Platform_A&position=top-right&fontSize=small
```
...
2. **Configure**
   - URL: `http://localhost:8096/ohio-wso-lower-third?fop=Platform_A`
...
```
Platform A: http://localhost:8096/ohio-wso-lower-third?fop=Platform_A
Platform B: http://localhost:8096/ohio-wso-lower-third?fop=Platform_B
Platform C: http://localhost:8096/ohio-wso-lower-third?fop=Platform_C
```
